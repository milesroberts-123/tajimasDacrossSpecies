...
allReads = rbind(allReads, data.frame(run = gossypium_barbadense[,"Run"], replicate = gossypium_barbadense[,"BioSample"], layout = gossypium_barbadense[,"layout"], genome = "gossypium_barbadense", ploidy = 2))
```
...
runsAllMetaData = list(actinidia_chinensis, aegilops_tauschii, amaranthus_hypochondriacus, ananas_comosus, arabidopsis_halleri, arabidopsis_lyrata, arabidopsis_suecica, arabidopsis_thaliana, arabis_alpina, arabis_nemorensis, arachis_duranensis, arachis_hypogaea, arachis_ipaensis, benincasa_hispida, beta_vulgaris, boechera_stricta, brachypodium_distachyon, brachypodium_sylvaticum, brassica_juncea, brassica_napus, brassica_nigra, brassica_oleracea, brassica_rapa, buddleja_alternifolia, cajanus_cajan, camelina_sativa, camellia_sinensis, cannabis_sativa, capsella_grandiflora, capsella_rubella, capsicum_annuum, chenopodium_quinoa, cicer_arietinum, citrullus_lanatus, coffea_arabica, coffea_canephora, corylus_avellana, cucurbita_argyrosperma, cucurbita_pepo, digitaria_exilis, dioscorea_alata, durio_zibethinus, elaeis_guineensis, eleusine_coracana, ficus_carica, glycine_max, glycine_soja, gossypium_arboreum, gossypium_barbadense, helianthus_annuus, heliosperma_pusillum, hordeum_vulgare, lactuca_sativa, lens_ervoides, lotus_japonicus, lupinus_angustifolius, malus_domestica, malus_sylvestris, mangifera_indica, manihot_esculenta, medicago_truncatula, mimulus_guttatus, miscanthus_sinensis, momordica_charantia, musa_acuminata, nelumbo_nucifera, nicotiana_tabacum, olea_europaea, oryza_barthii, oryza_brachyantha, oryza_glaberrima, oryza_longistaminata, oryza_meridionalis, oryza_punctata, oryza_rufipogon, panicum_hallii, papaver_somniferum, phoenix_dactylifera, pisum_sativum, populus_deltoides, populus_trichocarpa, prunus_armeniaca, quercus_lobata, raphanus_sativus, rhododendron_griersonianum, salix_dunnii, secale_cereale, setaria_viridis, solanum_chilense, solanum_melongena, solanum_stenotomum, spirodela_polyrhiza, striga_hermonthica, tetracentron_sinense, vanilla_planifolia, vigna_unguiculata, vitis_vinifera, xanthoceras_sorbifolium)
...
write.table(coverdf, "bp_sequenced.txt", sep = "\t", quote = F, row.names = F)
```
