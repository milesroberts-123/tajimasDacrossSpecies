...
allReads = rbind(allReads, data.frame(run = actinidia_chinensis[,"Run"], replicate = actinidia_chinensis[,"replicate"], layout = "SE", genome = "actinidia_chinensis", ploidy = 2, taxonKeys = "7270822"))
```
...
# add reads to growing list
allReads = rbind(allReads, data.frame(run = arachis_hypogaea[,"Run"], replicate = arachis_hypogaea[,"BioSample"], layout = "PE", genome = "arachis_hypogaea", ploidy = 4, taxonKeys = "5353758"))
...
allReads = rbind(allReads, data.frame(run = arachis_ipaensis[,"Run"], replicate = arachis_ipaensis[,"BioSample"], layout = "PE", genome = "arachis_ipaensis", ploidy = 2, taxonKeys = "5353793"))
```
