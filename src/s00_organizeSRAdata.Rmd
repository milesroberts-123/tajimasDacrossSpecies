...
```{r}
lotus_japonicus = read.csv("../workflow/data/SRArunInfo/SraRunInfo_lotus_japonicus_PRJEB27969.csv")
...
## Manihot esculenta
```{r}
manihot_esculenta = read.csv("../workflow/data/SRArunInfo/SraRunInfo_manihot_esculenta_PRJNA234389.csv")
...
## Medicago truncatula
```{r}
medicago_truncatula = read.csv("../workflow/data/SRArunInfo/SraRunInfo_medicago_truncatula_SRA026748.csv")
...
## Mimulus guttatus
```{r}
mimulus_guttatus = read.csv("../workflow/data/SRArunInfo/SraRunInfo_mimulus_guttatus_PRJNA344904.csv")
...
## Olea europaea
```{r}
olea_europaea = read.csv("../workflow/data/SRArunInfo/SraRunInfo_olea_europaea_PRJEB35540.csv")
...
## Oryza sativa
```{r}
oryza_sativa = read.csv("../workflow/data/SRArunInfo/SraRunInfo_oryza_sativa_PRJEB6180.csv")
...
## Panicum virgatum
```{r}
panicum_virgatum = read.csv("../workflow/data/SRArunInfo/SraRunInfo_panicum_virgatum_PRJNA622568.csv")
...
## Phaseolus vulgaris
```{r}
phaseolus_vulgaris = read.csv("../workflow/data/SRArunInfo/SraRunInfo_phaseolus_vulgaris_PRJNA515107.csv")
...
## Populus trichocarpa
```{r}
populus_trichocarpa = read.csv("../workflow/data/SRArunInfo/SraRunInfo_populus_trichocarpa_PRJNA276056.csv")
...
## Prunus persica
```{r}
prunus_persica = read.csv("../workflow/data/SRArunInfo/SraRunInfo_prunus_persica_PRJNA388029.csv")
...
prunus_persica_supp = read.csv("../workflow/data/SRArunInfo/doi10.1186s13059-019-1648-9_prunus_persica_TableS1_2022-10-20.csv")
...
## Setaria italica
```{r}
setaria_italica = read.csv("../workflow/data/SRArunInfo/SraRunInfo_setaria_italica_PRJEB1234.csv")
...
## Setaria viridis
```{r}
setaria_viridis = read.csv("../workflow/data/SRArunInfo/SraRunInfo_setaria_viridis_PRJNA633413.csv")
...
```{r}
solanum_lycopersicum = read.csv("../workflow/data/SRArunInfo/SraRunInfo_solanum_lycopersicum_PRJNA259308.csv")
...
## Sorghum bicolor
```{r}
sorghum_bicolor = read.csv("../workflow/data/SRArunInfo/SraRunInfo_sorghum_bicolor_PRJEB50066.csv")
...
## Spinacia oleracea
```{r}
spinacia_oleracea = read.csv("../workflow/data/SRArunInfo/SraRunInfo_spinacia_oleracea_PRJNA598728.csv")
...
## Spirodela polyrhiza
```{r}
spirodela_polyrhiza = read.csv("../workflow/data/SRArunInfo/SraRunInfo_spirodela_polyrhiza_PRJNA552613.csv")
...
## Vitis vinifera
```{r}
vitis_vinifera = read.csv("../workflow/data/SRArunInfo/SraRunInfo_vitis_vinifera_PRJNA373967.csv")
