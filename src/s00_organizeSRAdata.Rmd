...
# add reads to growing list
allReads = rbind(allReads, data.frame(run = sorghum_bicolor[,"Run"], replicate = sorghum_bicolor[,"BioSample"], layout = sorghum_bicolor[,"layout"], genome = "sorghum_bicolor", ploidy = 2, taxonKeys = "2705185"))
```
...
#write.table(coverdf, "../results/2023-03-26/bp_sequenced_2024-01-31.txt", sep = "\t", quote = F, row.names = F)
```
