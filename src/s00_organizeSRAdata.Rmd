...
# add reads to growing list
allReads = rbind(allReads, data.frame(run = brachypodium_sylvaticum[,"Run"], replicate = brachypodium_sylvaticum[,"BioSample"], layout = "SE", genome = "brachypodium_sylvaticum", ploidy = 2))
```
