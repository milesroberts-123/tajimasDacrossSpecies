...
# add reads to growing list
allReads = rbind(allReads, data.frame(run = panicum_halli[,"Run"], replicate = panicum_halli[,"BioSample"], layout = panicum_halli[,"layout"], genome = "panicum_halli", ploidy = 2, taxonKeys = "2705116"))
```
