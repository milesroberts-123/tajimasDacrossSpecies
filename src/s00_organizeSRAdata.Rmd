...
# add reads to growing list
allReads = rbind(allReads, data.frame(run = brassica_juncea[,"Run"], replicate = brassica_juncea[,"BioSample"], layout = brassica_juncea[,"layout"], genome = "brassica_juncea", ploidy = 4, taxonKeys = "3042624"))
```
...
#write.table(coverdf, "../results/2023-03-26/bp_sequenced_2023-09-19.txt", sep = "\t", quote = F, row.names = F)
```
