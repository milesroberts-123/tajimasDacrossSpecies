...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = brachypodium_distachyon[(brachypodium_distachyon$spots_with_mates > 0),"Run"], genome = "brachypodium_distachyon"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = brassica_oleracea[,"Run"], genome = "brassica_oleracea"))

allReads = rbind(allReads, data.frame(samples = brassica_rapa[,"Run"], genome = "brassica_rapa"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = capsella_grandiflora[,"Run"], genome = "capsella_grandiflora"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = capsella_rubella[(capsella_rubella$spots_with_mates > 0),"Run"], genome = "capsella_rubella"))
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = chenopodium_quinoa[,"Run"], genome = "chenopodium_quinoa"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = cicer_arietinum[,"Run"], genome = "cicer_arietinum"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = citrullus_lanatus[,"Run"], genome = "citrullus_lanatus"))
```
## Cucumis sativus
```{r}
# load data
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = glycine_max[(glycine_max$spots_with_mates > 0),"Run"], genome = "glycine_max"))
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = glycine_soja[,"Run"], genome = "glycine_soja"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = gossypium_barbadense[,"Run"], genome = "gossypium_barbadense"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = gossypium_hirsutum[,"Run"], genome = "gossypium_hirsutum"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = runs, genome = "hordeum_vulgare"))
```
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = lactuca_sativa[,"Run"], genome = "lactuca_sativa"))
...
# add reads to list
allReads = rbind(allReads, data.frame(samples = lotus_japonicus[,"Run"], genome = "lotus_japonicus"))
```
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = manihot_esculenta[(manihot_esculenta$spots_with_mates > 0),"Run"], genome = "manihot_esculenta"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = medicago_truncatula[,"Run"], genome = "medicago_truncatula"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = mimulus_guttatus[,"Run"], genome = "mimulus_guttatus"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = olea_europaea[,"Run"], genome = "olea_europaea"))
```
...
oryza_sativa$layout[(oryza_sativa$spots_with_mates > 0)] = "PE"
oryza_sativa$layout[(oryza_sativa$spots_with_mates == 0)] = "SE"
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = panicum_halli[(panicum_halli$spots_with_mates > 0),"Run"], genome = "panicum_halli"))

# seReads = rbind(seReads, data.frame(samples = panicum_halli[(panicum_halli$spots_with_mates == 0),"Run"], genome = "panicum_halli"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = panicum_virgatum[(panicum_virgatum$spots_with_mates > 0),"Run"], genome = "panicum_virgatum"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = phaseolus_vulgaris[(phaseolus_vulgaris$spots_with_mates > 0),"Run"], genome = "phaseolus_vulgaris"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = populus_trichocarpa[(populus_trichocarpa$spots_with_mates > 0),"Run"], genome = "populus_trichocarpa"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = prunus_persica[(prunus_persica$spots_with_mates > 0),"Run"], genome = "prunus_persica"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = setaria_italica[(setaria_italica$spots_with_mates > 0),"Run"], genome = "setaria_italica"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = setaria_viridis[(setaria_viridis$spots_with_mates > 0),"Run"], genome = "setaria_viridis"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = solanum_lycopersicum[(solanum_lycopersicum$spots_with_mates > 0),"Run"], genome = "solanum_lycopersicum"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = sorghum_bicolor[(sorghum_bicolor$spots_with_mates > 0),"Run"], genome = "sorghum_bicolor"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = spinacia_oleracea[(spinacia_oleracea$spots_with_mates > 0),"Run"], genome = "spinacia_oleracea"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = spirodela_polyrhiza[(spirodela_polyrhiza$spots_with_mates > 0),"Run"], genome = "spirodela_polyrhiza"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = vitis_vinifera[(vitis_vinifera$spots_with_mates > 0),"Run"], genome = "vitis_vinifera"))
...
# add reads to growing list
allReads = rbind(allReads, data.frame(samples = zea_mays[(zea_mays$spots_with_mates > 0),"Run"], genome = "zea_mays"))
...
table(allReads$genome)
table(seReads$genome)

# number of species included thus far
length(unique(c(allReads$genome,seReads$genome)))

# total number of individuals
nrow(allReads) + nrow(seReads)
```
