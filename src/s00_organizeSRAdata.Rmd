...
runsAllMetaData = list(actinidia_chinensis, amaranthus_hypochondriacus, ananas_comosus, arabidopsis_halleri, arabidopsis_lyrata, arabidopsis_suecica, arabis_nemorensis, arachis_hypogaea, arachis_ipaensis, camelina_sativa, ficus_carica, nicotiana_tabacum, oryza_punctata)
