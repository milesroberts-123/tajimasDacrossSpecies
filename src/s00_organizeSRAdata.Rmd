...
testSet = allReads[(allReads$genome %in% c("arabidopsis_halleri", "arabidopsis_lyrata", "arabidopsis_thaliana", "boechera_stricta", "brassica_oleracea", "brassica_rapa", "capsella_grandiflora", "capsella_rubella")),]
