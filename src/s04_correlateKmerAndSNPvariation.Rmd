...
phy = read.tree("../results/2023-03-26/species_list_2023-10-03.nwk")
...
```{r}
height = read.table("../workflow/data/eol_plant_height_data_2023-10-03/records.tsv", header = T, fill = T, quote = "", sep = "\t")
...
for(i in 1:nrow(alldiv)){
  ...
  height_sub$final_values = height_sub$Measurement.Value
  height_sub$final_values[(height_sub$Measurement.Unit == "feet")] = height_sub$final_values[(height_sub$Measurement.Unit == "feet")]*0.3048
