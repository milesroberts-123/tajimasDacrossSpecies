...
# load time tree
phy = read.tree("../results/2023-03-26/species_list_2023-09-12.nwk")
...
area_vs_pi = pgls(log10(rangeArea) ~ log10(pi), compdata)
summary(area_vs_pi)

area_vs_bcd = pgls(log10(rangeArea) ~ bcd, compdata)
summary(area_vs_bcd)
