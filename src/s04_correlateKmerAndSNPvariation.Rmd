...
correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_pi$y, genome_gbif_all_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp), adj.", "log(Nucleotide diversity), adj.")
```
...
ggsave(paste("wcvp_vs_gbif_and_jac_vs_bcd_", today, ".png", sep = ""), width = 16.5, height = 16)
...
ggsave(paste("coverage_vs_diversity_", today, ".png", sep = ""), width = 16, height = 16, units = "in")
...
ggsave(paste("pi_vs_jac_and_bcd_high_vs_low_cov_", today, ".png", sep = ""), width = 11, height = 10, units = "in")
...
ggsave(paste("diversity_vs_popsize_", today, ".png", sep = ""), width = 12, height = 16, units = "in")
...
ggsave(paste("wcvp_popsize_vs_diversity_corrected_", today, ".png", sep = ""), height = 12, width = 16, units = "in")
...
ggsave(paste("wcvp_area_vs_diversity_corrected_", today, ".png", sep = ""), height = 12, width = 16, units = "in")
...
ggsave(paste("gbif_popsize_vs_diversity_corrected_", today, ".png", sep = ""), height = 12, width = 16, units = "in")
...
ggsave(paste("gbif_area_vs_diversity_corrected_", today, ".png", sep = ""), height = 12, width = 16, units = "in")
...
ggsave(paste("height_vs_diversity_corrected_", today, ".png", sep = ""), height = 6, width = 16, units = "in")
...
all_mod_results$`Diversity metric (response)` = rep(
    c(
