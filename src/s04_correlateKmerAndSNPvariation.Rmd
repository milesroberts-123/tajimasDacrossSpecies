...
abline(a = 0, b = 1)
cor(alldiv$bcd, alldiv$jac, method = "spearman")

plot(alldiv$pi, alldiv$bcd)
cor(alldiv$pi, alldiv$bcd, method = "spearman")

plot(alldiv$pi, alldiv$jac)
cor(alldiv$pi, alldiv$jac, method = "spearman")
...
pgls(scale(pi) ~ rangeArea, compdata)
pgls(scale(jac) ~ rangeArea, compdata)
pgls(scale(bcd) ~ rangeArea, compdata)

pgls(rangeArea ~ scale(pi) + scale(bcd), compdata)
pgls(scale(rangeArea) ~ scale(pi) + scale(jac), compdata)
