...
phy = read.tree("../results/2023-03-26/species_list_2024-02-12.nwk")
...
ida_nidv_vs_pi = my_ggplot_wrap(alldiv, "nidv", "log10(pi)", "Number of biosamples sequenced", "log10(Nucleotide diversity)", paste("ida_nidv-vs-pi_", today, ".png", sep = ""))
...
mod_wcvp_native_popsize_pi = pgls(log10(pi) ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_pi)
plot(mod_wcvp_native_popsize_pi)

mod_wcvp_native_popsize_jac = pgls(jac ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_jac)
plot(mod_wcvp_native_popsize_jac)

mod_wcvp_native_popsize_bcd = pgls(bcd ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_bcd)
plot(mod_wcvp_native_popsize_bcd)

##############################WCVP all population size vs diversity######################

mod_wcvp_all_popsize_pi = pgls(log10(pi) ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_pi)
plot(mod_wcvp_all_popsize_pi)

mod_wcvp_all_popsize_jac = pgls(jac ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_jac)
plot(mod_wcvp_all_popsize_jac)

mod_wcvp_all_popsize_bcd = pgls(bcd ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_bcd)
plot(mod_wcvp_all_popsize_bcd)

############################GBIF native population size vs diversity####################

mod_gbif_native_popsize_pi = pgls(log10(pi) ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_pi)

mod_gbif_native_popsize_jac = pgls(jac ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_jac)

mod_gbif_native_popsize_bcd = pgls(bcd ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_bcd)

##########################GBIF all population size vs diversity##########################

mod_gbif_all_popsize_pi = pgls(log10(pi) ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_all_popsize_pi)

mod_gbif_all_popsize_jac = pgls(jac ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_all_popsize_jac)

mod_gbif_all_popsize_bcd = pgls(bcd ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
...
correct_and_plot = function(mod_mat, y, V, primary, xlab, ylab, ppos){
  ...
  myplot = ggplot(mapping = aes(x = X_star[,primary], y = y_star_corrected)) +
    ...
    annotate(geom = "text", x = ppos, y = (max(y_star_corrected) + min(y_star_corrected))*0.5, label = p.label) +
    labs(x = xlab, y = ylab)
...
wcvp_native_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_pi$y, mod_wcvp_native_popsize_pi$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "log(Nucleotide diversity), adj.", 3)

wcvp_all_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_pi$y, mod_wcvp_all_popsize_pi$Vt, "log(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "log(Nucleotide diversity), adj.", 1.5)

wcvp_native_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_jac$y, mod_wcvp_native_popsize_jac$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "Jaccard dissimilarity, adj.", 3)

wcvp_all_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_jac$y, mod_wcvp_all_popsize_jac$Vt, "log10(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "Jaccard dissimilarity, adj.", 1.5)

wcvp_native_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_bcd$y, mod_wcvp_native_popsize_bcd$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "Bray-Curtis dissimilarity, adj.", 3)

wcvp_all_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_bcd$y, mod_wcvp_all_popsize_bcd$Vt, "log10(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "Bray-Curtis dissimilarity, adj.", 1.5)

## gbif

gbif_native_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_pi$y, mod_gbif_native_popsize_pi$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "log(Nucleotide diversity), adj.", -2)

gbif_all_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_pi$y, mod_gbif_all_popsize_pi$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "log(Nucleotide diversity), adj.", -2)

gbif_native_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_jac$y, mod_gbif_native_popsize_jac$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "Jaccard dissimilarity, adj.", -2)

gbif_all_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_jac$y, mod_gbif_all_popsize_jac$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "Jaccard dissimilarity, adj.", -2)

gbif_native_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_bcd$y, mod_gbif_native_popsize_bcd$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "Bray-Curtis dissimilarity, adj.", -2)

gbif_all_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_bcd$y, mod_gbif_all_popsize_bcd$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "Bray-Curtis dissimilarity, adj.", -2)
...
ggarrange(wcvp_native_vs_pi_corrected, wcvp_native_vs_jac_corrected, wcvp_native_vs_bcd_corrected, wcvp_all_vs_pi_corrected, wcvp_all_vs_jac_corrected, wcvp_all_vs_bcd_corrected,nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"))

ggsave(paste("wcvp_vs_diversity_corrected_", today, ".png", sep = ""), height = 9, width = 13.5, units = "in")

ggarrange(gbif_native_vs_pi_corrected, gbif_native_vs_jac_corrected, gbif_native_vs_bcd_corrected, gbif_all_vs_pi_corrected, gbif_all_vs_jac_corrected, gbif_all_vs_bcd_corrected,nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"))

ggsave(paste("gbif_vs_diversity_corrected_", today, ".png", sep = ""), height = 9, width = 13.5, units = "in")
```
...
ggtree(plotphy, size = 1.5) + 
    geom_facet(panel = "log10(GBIF native pop size proxy + 1)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(gbif_native_popsize + 1)), color = plotpal[1]) +
    geom_facet(panel = "log10(WCVP native pop size proxy)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(wcvp_native_popsize)), color = plotpal[2]) +
