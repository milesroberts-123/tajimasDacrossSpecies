...
plotpal = c("#351338","#6F2C06","#6C702C","#69A3A5","#DAD2FF")
#plotpal = c("#191900","#663329","#D85F4D","#ECAC54","#FFFECB")

# plot phylogeny alongside other data
ggtree(plotphy, size = 1.5) + 
    geom_facet(panel = "log10(SNP diversity)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(pi)), color = plotpal[1]) +
  geom_facet(panel = "Bray-Curtis dissimilarity", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = bcd), color = plotpal[2]) +
  geom_facet(panel = "Jaccard dissimilarity", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = jac), color = plotpal[3]) +
  geom_facet(panel = "Number of individuals sequenced", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = nidv), color = plotpal[4]) +
  geom_facet(panel = "Base pairs sequenced per individual", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = totalbp/nidv), color = plotpal[5]) +
  theme_tree2() +
