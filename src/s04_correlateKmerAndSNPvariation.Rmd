...
phy = read.tree("../results/2023-03-26/species_list_2024-02-14.nwk")
...
ida_wcvp_vs_gbif = my_ggplot_wrap_line(alldiv, "log10(wcvp_native_area)", "log10(gbif_native_area)", "log10(WCVP range size in square km)", "log10(GBIF range size in square km)", paste("ida_wcvp-vs-gbif_", today, ".png", sep = ""))

# compare number of individuals sequenced to diversity measures
ida_nidv_vs_pi = my_ggplot_wrap(alldiv, "nidv", "log10(pi)", "Number of biosamples sequenced)", "log(Nucleotide diversity)", paste("ida_nidv-vs-pi_", today, ".png", sep = ""))
...
## replot trends
```{r}
my_ggplot_wrap(subdiv, "log10(meancov)", "log10(pi)", "log10(mean coverage)", "log10(Nucleotide diversity)", paste("cda_coverage-vs-pi_", today, ".png"))

my_ggplot_wrap(subdiv, "log10(meancov)", "jac", "log10(mean coverage)", "Jaccard dissimilarity", paste("cda_coverage-vs-jac_", today, ".png"))

my_ggplot_wrap(subdiv, "log10(meancov)", "bcd", "log10(mean coverage)", "Bray-Curtis dissimilarity", paste("cda_coverage-vs-bcd_", today, ".png"))
...
cda_pi_vs_jac = my_ggplot_wrap_xyz(subdiv, "log10(pi)", "jac", "log(Nucleotide diversity)", "Jaccard dissimilarity", paste("cda_pi-vs-jac_", today, ".png"), "log10(meancov)", "#FEF2F2", "#190C64", "log(mean coverage)", c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))

cda_pi_vs_bcd = my_ggplot_wrap_xyz(subdiv, "log10(pi)", "bcd", "log(Nucleotide diversity)", "Bray-Curtis dissimilarity", paste("cda_pi-vs-bcd_", today, ".png"), "log10(meancov)", "#FEF2F2", "#190C64", "log(mean coverage)", c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))

my_ggplot_wrap(subdiv, "jac", "bcd", "Jaccard dissimilarity", "Bray-Curtis dissimilarity", paste("cda_jac-vs-bcd_", today, ".png"))

# compare population size proxies with diversity
cda_pi_vs_wcvp = my_ggplot_wrap(subdiv, "log10(pi)", "log10(wcvp_native_popsize)", "log10(Nucleotide diversity)", "log10(WCVP pop size proxy)", paste("cda_pi-vs-wcvp_", today, ".png"))

cda_pi_vs_gbif = my_ggplot_wrap(subdiv, "log10(pi)", "log10(gbif_native_popsize + 1)", "log10(Nucleotide diversity)", "log10(GBIF pop size proxy + 1)", paste("cda_pi-vs-gbif_", today, ".png"))

cda_jac_vs_wcvp = my_ggplot_wrap(subdiv, "jac", "log10(wcvp_native_popsize)", "Jaccard dissimilarity", "log10(WCVP pop size proxy)", paste("cda_jac-vs-wcvp_", today, ".png"))

cda_jac_vs_gbif = my_ggplot_wrap(subdiv, "jac", "log10(gbif_native_popsize + 1)", "Jaccard dissimilarity", "log10(GBIF pop size proxy)", paste("cda_jac-vs-gbif_", today, ".png"))

cda_bcd_vs_wcvp = my_ggplot_wrap(subdiv, "bcd", "log10(wcvp_native_popsize)", "Bray-Curtis dissimilarity", "log10(WCVP pop size proxy)", paste("cda_bcd-vs-wcvp_", today, ".png"))

cda_bcd_vs_gbif = my_ggplot_wrap(subdiv, "bcd", "log10(gbif_native_popsize + 1)", "Bray-Curtis dissimilarity", "log10(GBIF pop size proxy)", paste("cda_bcd-vs-gbif_", today, ".png"))
```
...
wcvp_compdata = comparative.data(phy, subdiv[,c("species","pi", "jac", "bcd", "genome.size", "meancov", "nidv", "cvbp", "cultivation.status", "Mating.system", "wcvp_native_popsize", "wcvp_all_popsize", "wcvp_native_area", "wcvp_all_area", "height_final")], names.col = "species", vcv = T)
...
mod_wcvp_native_popsize_pi = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_pi)
plot(mod_wcvp_native_popsize_pi)

mod_wcvp_native_popsize_jac = pgls(scale(jac) ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_jac)
plot(mod_wcvp_native_popsize_jac)

mod_wcvp_native_popsize_bcd = pgls(scale(bcd) ~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_bcd)
plot(mod_wcvp_native_popsize_bcd)

##############################WCVP all population size vs diversity######################

mod_wcvp_all_popsize_pi = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_pi)
plot(mod_wcvp_all_popsize_pi)

mod_wcvp_all_popsize_jac = pgls(scale(jac) ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_jac)
plot(mod_wcvp_all_popsize_jac)

mod_wcvp_all_popsize_bcd = pgls(scale(bcd) ~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_bcd)
plot(mod_wcvp_all_popsize_bcd)

############################GBIF native population size vs diversity####################

mod_gbif_native_popsize_pi = pgls(scale(log10(pi)) ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_pi)

mod_gbif_native_popsize_jac = pgls(scale(jac) ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_jac)

mod_gbif_native_popsize_bcd = pgls(scale(bcd) ~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_native_popsize_bcd)

##########################GBIF all population size vs diversity##########################

mod_gbif_all_popsize_pi = pgls(scale(log10(pi)) ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_all_popsize_pi)

mod_gbif_all_popsize_jac = pgls(scale(jac) ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_all_popsize_jac)

mod_gbif_all_popsize_bcd = pgls(scale(bcd) ~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, gbif_compdata)
summary(mod_gbif_all_popsize_bcd)

# create model matrices for plotting multiple regressions
mod_mat_wcvp_native = model.matrix(~ log10(wcvp_native_popsize) + Mating.system + cultivation.status, data = wcvp_compdata$data)

mod_mat_wcvp_all = model.matrix(~ log10(wcvp_all_popsize) + Mating.system + cultivation.status, data = wcvp_compdata$data)

mod_mat_gbif_native = model.matrix(~ log10(gbif_native_popsize + 1) + Mating.system + cultivation.status, data = gbif_compdata$data)

mod_mat_gbif_all = model.matrix(~ log10(gbif_all_popsize + 1) + Mating.system + cultivation.status, data = gbif_compdata$data)
...
# build models 
mod_wcvp_native_popsize_pi = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_pi)
plot(mod_wcvp_native_popsize_pi)

#mod_wcvp_native_popsize_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
#summary(mod_wcvp_native_popsize_pi_2)

#mod_wcvp_native_popsize_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + nidv + log10(genome.size) + cvbp + Mating.system, wcvp_compdata)
#summary(mod_wcvp_native_popsize_pi_3)
#plot(mod_wcvp_native_popsize_pi_3)

mod_mat_wcvp_native_popsize_pi = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, data = wcvp_compdata$data) # minimal model, extract matrix

# Jaccard dissimilarity vs WCVP popsize
mod_wcvp_native_popsize_jac = pgls(scale(jac) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_jac)
plot(mod_wcvp_native_popsize_jac)

mod_mat_wcvp_native_popsize_jac = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata$data) # minimal model, extract matrix

# Bray-Curtis dissimilarity vs WCVP popsize
mod_wcvp_native_popsize_bcd = pgls(scale(bcd) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_native_popsize_bcd)
plot(mod_wcvp_native_popsize_bcd)

mod_mat_wcvp_native_popsize_bcd = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata$data) # minimal model, extract matrix

###############WCVP all population size vs diversity################# 

# pi

mod_wcvp_all_popsize_pi_1 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_pi_1)

mod_wcvp_all_popsize_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system, wcvp_compdata)
summary(mod_wcvp_all_popsize_pi_2)

mod_wcvp_all_popsize_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + nidv + log10(genome.size) + cvbp + Mating.system, wcvp_compdata)
summary(mod_wcvp_all_popsize_pi_3)

# jac

mod_wcvp_all_popsize_jac_1 = pgls(scale(jac) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcvp_all_popsize_jac_1)

# bcd

mod_wcvp_all_popsize_bcd_1 = pgls(scale(bcd) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
...
# pi
mod_wcvp_native_area_pi_1 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcv_native_area_pi_1)

mod_wcvp_native_area_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_wcv_native_area_pi_2)

mod_wcvp_native_area_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system, wcvp_compdata)
summary(mod_wcvp_native_area_pi_3)
plot(mod_wcvp_native_area_pi_3)

mod_mat_wcvp_native_area_pi = model.matrix(~log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system, data = wcvp_compdata$data) # minimal model, extract matrix

# jaccard dissimilarity
mod_jac_wcvp_area_1 = pgls(scale(jac) ~ log10(area) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_jac_wcvp_area_1)
plot(mod_jac_wcvp_area_1)

mod_mat_wcvp_area_vs_jac = model.matrix(~ log10(area) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, data = wcvp_compdata$data) # minimal model, extract matrix

# bray-curtis dissimilarity
mod_bcd_wcvp_area_1 = pgls(scale(bcd) ~ log10(area) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_bcd_wcvp_area_1)

mod_bcd_wcvp_area_2 = pgls(scale(bcd) ~ log10(area) + log10(meancov) + nidv + log10(genome.size) + cvbp + cultivation.status, wcvp_compdata)
summary(mod_bcd_wcvp_area_2)
plot(mod_bcd_wcvp_area_2)

mod_mat_wcvp_area_vs_bcd = model.matrix(~ log10(area) + log10(meancov) + nidv + log10(genome.size) + cvbp + cultivation.status, data = wcvp_compdata$data) # minimal model, extract matrix

######################## height vs diversity ########################

# pi
mod_pi_height_1 = pgls(scale(log10(pi)) ~ height_final + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_pi_height_1)

mod_pi_height_2 = pgls(scale(log10(pi)) ~ height_final + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_pi_height_2)

mod_pi_height_3 = pgls(scale(log10(pi)) ~ height_final + nidv + log10(genome.size) + cvbp + Mating.system, wcvp_compdata)
summary(mod_pi_height_3)

# jaccard dissimilarity
mod_jac_height_1 = pgls(scale(jac) ~ height_final + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_jac_height_1)

# bray-curtis dissimilarity
mod_bcd_height_1 = pgls(scale(bcd) ~ height_final + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, wcvp_compdata)
summary(mod_bcd_height_1)

mod_bcd_height_2 = pgls(scale(bcd) ~ height_final + log10(meancov) + nidv + log10(genome.size) + cvbp + cultivation.status, wcvp_compdata)
...
gbif_native_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_pi$y, mod_gbif_native_popsize_pi$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "log(Nucleotide diversity), adj.")

gbif_all_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_pi$y, mod_gbif_all_popsize_pi$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "log(Nucleotide diversity), adj.")

gbif_native_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_jac$y, mod_gbif_native_popsize_jac$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "Jaccard dissimilarity, adj.")

gbif_all_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_jac$y, mod_gbif_all_popsize_jac$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "Jaccard dissimilarity, adj.")

gbif_native_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_bcd$y, mod_gbif_native_popsize_bcd$Vt, "log10(gbif_native_popsize + 1)", "log(GBIF native proxy + 1), adj.", "Bray-Curtis dissimilarity, adj.")

gbif_all_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_bcd$y, mod_gbif_all_popsize_bcd$Vt, "log10(gbif_all_popsize + 1)", "log(GBIF native+invaded proxy + 1), adj.", "Bray-Curtis dissimilarity, adj.")
...
ggsave(paste("wcvp_vs_gbif_and_jac_vs_bcd_", today, ".png", sep = ""), width = 16, height = 7)
...
ggarrange(ida_pi_vs_jac, cda_pi_vs_jac, ida_pi_vs_bcd, cda_pi_vs_bcd, ncol = 2, nrow = 2, common.legend = T, labels = c("A", "B", "C", "D"), legend = "top")
...
ggarrange(wcvp_native_vs_pi_corrected, wcvp_native_vs_jac_corrected, wcvp_native_vs_bcd_corrected,nrow = 1, ncol = 3, labels = c("A", "B", "C"))

ggsave(paste("wcvp_native_vs_diversity_corrected_", today, ".png", sep = ""), height = 6, width = 16, units = "in")

ggarrange(wcvp_all_vs_pi_corrected, wcvp_all_vs_jac_corrected, wcvp_all_vs_bcd_corrected,nrow = 1, ncol = 3, labels = c("A", "B", "C"))

ggsave(paste("wcvp_all_vs_diversity_corrected_", today, ".png", sep = ""), height = 6, width = 16, units = "in")

ggarrange(gbif_native_vs_pi_corrected, gbif_native_vs_jac_corrected, gbif_native_vs_bcd_corrected, nrow = 1, ncol = 3, labels = c("A", "B", "C"))

ggsave(paste("gbif_native_vs_diversity_corrected_", today, ".png", sep = ""), height = 6, width = 16, units = "in")

ggarrange(gbif_all_vs_pi_corrected, gbif_all_vs_jac_corrected, gbif_all_vs_bcd_corrected, nrow = 1, ncol = 3, labels = c("A", "B", "C"))

ggsave(paste("gbif_all_vs_diversity_corrected_", today, ".png", sep = ""), height = 6, width = 16, units = "in")
