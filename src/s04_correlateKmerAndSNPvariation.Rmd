...
wcvp_all_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_pi$y, mod_wcvp_all_popsize_pi$Vt, "log10(wcvp_all_popsize)", "log(WCVP full proxy), adj.", "log(Nucleotide diversity), adj.")

wcvp_all_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_pi$y, mod_wcvp_all_area_pi$Vt, "log10(wcvp_all_area)", "log(WCVP full range size, km^2), adj.", "log(Nucleotide diversity), adj.")
...
wcvp_all_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_jac$y, mod_wcvp_all_popsize_jac$Vt, "log10(wcvp_all_popsize)", "log(WCVP full proxy), adj.", "Jaccard dissimilarity, adj.")

wcvp_all_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_jac$y, mod_wcvp_all_area_jac$Vt, "log10(wcvp_all_area)", "log(WCVP full range size, km^2), adj.", "Jaccard dissimilarity, adj.")
...
wcvp_all_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_bcd$y, mod_wcvp_all_popsize_bcd$Vt, "log10(wcvp_all_popsize)", "log(WCVP full proxy), adj.", "Bray-Curtis dissimilarity, adj.")

wcvp_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_bcd$y, mod_wcvp_all_area_bcd$Vt, "log10(wcvp_all_area)", "log(WCVP full range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")
...
gbif_all_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_pi$y, mod_gbif_all_popsize_pi$Vt, "log10(gbif_all_popsize)", "log(GBIF full proxy), adj.", "log(Nucleotide diversity), adj.")

gbif_all_area_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_pi$y, mod_gbif_all_area_pi$Vt, "log10(gbif_all_area)", "log(GBIF full range size, km^2), adj.", "log(Nucleotide diversity), adj.")
...
gbif_all_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_jac$y, mod_gbif_all_popsize_jac$Vt, "log10(gbif_all_popsize)", "log(GBIF full proxy), adj.", "Jaccard dissimilarity, adj.")

gbif_all_area_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_jac$y, mod_gbif_all_area_jac$Vt, "log10(gbif_all_area)", "log(GBIF full range size, km^2), adj.", "Jaccard dissimilarity, adj.")
...
gbif_all_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_bcd$y, mod_gbif_all_popsize_bcd$Vt, "log10(gbif_all_popsize)", "log(GBIF full proxy), adj.", "Bray-Curtis dissimilarity, adj.")

gbif_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_bcd$y, mod_gbif_all_area_bcd$Vt, "log10(gbif_all_area)", "log(GBIF full range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")
