...
metadata = read.table("../results/2023-03-26/species_metadata_2024-02-20.txt", sep = "\t", fill = T, quote = "", header = T)
...
```{r eval=FALSE, include=FALSE}
alldiv = read.table("../results/2023-03-26/final_covariates_2024-03-13.txt", sep = "\t", header = T)
```
...
phy = read.tree("../results/2023-03-26/species_list_2024-03-13.nwk")
...
my_ggplot_wrap_lm <- function(data, xcol, ycol, xname, yname, filename, filew = 7, fileh = 7) {
  # get correlation coefficient
  x = with(data, eval(str2expression(xcol)))
  y = with(data, eval(str2expression(ycol)))
  test_results = cor.test(x, y, method = "spearman")
...
my_ggplot_wrap_barplot = function(data, var1, var2, xname, yname, lname, my_colors, filename, filew = 7, fileh = 7){
...
ida_meancov_vs_pi = my_ggplot_wrap(alldiv, "log10(meancov)", "pi", "log10(mean coverage per biosample)", "Nucleotide diversity", paste("ida_coverage-vs-pi_", today, ".png", sep = ""))

ida_meancov_vs_jac = my_ggplot_wrap(alldiv, "log10(meancov)", "jac", "log(mean coverage per biosample)", "Jaccard dissimilarity", paste("ida_coverage-vs-jac_", today, ".png", sep = ""))

ida_meancov_vs_bcd = my_ggplot_wrap(alldiv, "log10(meancov)", "bcd", "log(mean coverage per biosample)", "Bray-Curtis dissimilarity", paste("ida_coverage-vs-bcd_", today, ".png", sep = ""))

## depth of sequencing variation vs diversity
ida_cvbp_vs_pi = my_ggplot_wrap(alldiv, "cvbp", "pi", "Coefficient of variation in bp sequenced", "Nucleotide diversity", paste("ida_cvbp-vs-pi_", today, ".png", sep = ""))
...
ida_cvbp_vs_bcd = my_ggplot_wrap(alldiv, "cvbp", "bcd", "Coefficient of variation in bp sequenced", "Bray-Curtis dissimilarity", paste("ida_cvbp-vs-bcd_", today, ".png", sep = ""))

## number of individuals sequenced vs diversity
ida_nidv_vs_pi = my_ggplot_wrap(alldiv, "log10(nidv)", "pi", "log(Number of biosamples sequenced)", "Nucleotide diversity", paste("ida_nidv-vs-pi_", today, ".png", sep = ""))

ida_nidv_vs_jac = my_ggplot_wrap(alldiv, "log10(nidv)", "jac", "log(Number of biosamples sequenced)", "Jaccard dissimilarity", paste("ida_nidv-vs-jac_", today, ".png", sep = ""))

ida_nidv_vs_bcd = my_ggplot_wrap(alldiv, "log10(nidv)", "bcd", "log(Number of biosamples sequenced)", "Bray-Curtis dissimilarity", paste("ida_nidv-vs-bcd_", today, ".png", sep = ""))
...
ida_pi_vs_jac_cvbp = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "jac", "log10(Nucleotide diversity)", "Jaccard dissimilarity", paste("ida_pi-vs-jac_cvbp_", today, ".png", sep = ""), "cvbp", "#FEF2F2", "#190C64", "Coefficient\nof variation\nbp sequenced", c(min(alldiv$cvbp), max(alldiv$cvbp)))

ida_pi_vs_bcd_cvbp = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "bcd", "log10(Nucleotide diversity)", "Bray-Curtis dissimilarity", paste("ida_pi-vs-bcd_cvbp_", today, ".png", sep = ""), "cvbp", "#FEF2F2", "#190C64", "Coefficient\nof variation\nbp sequenced", c(min(alldiv$cvbp), max(alldiv$cvbp)))
...
ida_wcvp_vs_gbif_native = my_ggplot_wrap_line(alldiv, "log10(wcvp_native_area)", "log10(gbif_native_area)", expression(bold("log(WCVP native range)"~km^2)), expression(bold("log(GBIF native range)"~km^2)), paste("ida_wcvp-vs-gbif_native_", today, ".png", sep = ""))

ida_wcvp_vs_gbif_all = my_ggplot_wrap_line(alldiv, "log10(wcvp_all_area)", "log10(gbif_all_area)", expression(bold("log(WCVP full range)"~km^2)), expression(bold("log(GBIF full range)"~km^2)), paste("ida_wcvp-vs-gbif_all_", today, ".png", sep = ""))
...
my_ggplot_wrap(subdiv, "cvbp", "log10(pi)", "Coefficient of variation in base pairs sequenced across all samples", "log10(Nucleotide diversity)", paste("cda_cvbp-vs-pi_", today, ".png", sep = ""))

my_ggplot_wrap(subdiv, "cvbp", "jac", "Coefficient of variation in base pairs sequenced across all samples", "Jaccard dissimilarity", paste("cda_cvbp-vs-jac_", today, ".png", sep = ""))

my_ggplot_wrap(subdiv, "cvbp", "bcd", "Coefficient of variation in base pairs sequenced across all samples", "Bray-Curtis dissimilarity", paste("cda_cvbp-vs-bcd_", today, ".png", sep = ""))
...
cda_pi_vs_wcvp = my_ggplot_wrap(subdiv, "log10(pi)", "log10(wcvp_native_popsize)", "log(Nucleotide diversity)", "log(WCVP native proxy)", paste("cda_pi-vs-wcvp_", today, ".png", sep = ""))

cda_pi_vs_gbif = my_ggplot_wrap(subdiv, "log10(pi)", "log10(gbif_native_popsize)", "log(Nucleotide diversity)", "log(GBIF native proxy)", paste("cda_pi-vs-gbif_", today, ".png", sep = ""))

cda_jac_vs_wcvp = my_ggplot_wrap(subdiv, "jac", "log10(wcvp_native_popsize)", "Jaccard dissimilarity", "log(WCVP native proxy)", paste("cda_jac-vs-wcvp_", today, ".png", sep = ""))

cda_jac_vs_gbif = my_ggplot_wrap(subdiv, "jac", "log10(gbif_native_popsize)", "Jaccard dissimilarity", "log(GBIF native proxy)", paste("cda_jac-vs-gbif_", today, ".png", sep = ""))

cda_bcd_vs_wcvp = my_ggplot_wrap(subdiv, "bcd", "log10(wcvp_native_popsize)", "Bray-Curtis dissimilarity", "log(WCVP native proxy)", paste("cda_bcd-vs-wcvp_", today, ".png", sep = ""))

cda_bcd_vs_gbif = my_ggplot_wrap(subdiv, "bcd", "log10(gbif_native_popsize)", "Bray-Curtis dissimilarity", "log10(GBIF native proxy)", paste("cda_bcd-vs-gbif_", today, ".png", sep = ""))
```
...
# for now, comment out old models controlling for every factor
if(FALSE){
##############################WCVP native population size vs pi##########################

# build models 
mod_wcvp_native_popsize_pi = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_native_popsize_pi)
plot(mod_wcvp_native_popsize_pi)

#mod_wcvp_native_popsize_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
#summary(mod_wcvp_native_popsize_pi_2)

#mod_wcvp_native_popsize_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_native_popsize) + nidv + log10(genome.size) + cvbp + Mating.system, compdata)
#summary(mod_wcvp_native_popsize_pi_3)
#plot(mod_wcvp_native_popsize_pi_3)

mod_mat_wcvp_native_popsize_pi = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, data = compdata$data) # minimal model, extract matrix

# Jaccard dissimilarity vs WCVP popsize
mod_wcvp_native_popsize_jac = pgls(scale(jac) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_native_popsize_jac)
plot(mod_wcvp_native_popsize_jac)

mod_mat_wcvp_native_popsize_jac = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata$data) # minimal model, extract matrix

# Bray-Curtis dissimilarity vs WCVP popsize
mod_wcvp_native_popsize_bcd = pgls(scale(bcd) ~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_native_popsize_bcd)
plot(mod_wcvp_native_popsize_bcd)

mod_mat_wcvp_native_popsize_bcd = model.matrix(~ log10(wcvp_native_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata$data) # minimal model, extract matrix

###############WCVP all population size vs diversity################# 

# pi

mod_wcvp_all_popsize_pi_1 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_all_popsize_pi_1)

mod_wcvp_all_popsize_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system, compdata)
summary(mod_wcvp_all_popsize_pi_2)

mod_wcvp_all_popsize_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_all_popsize) + nidv + log10(genome.size) + cvbp + Mating.system, compdata)
summary(mod_wcvp_all_popsize_pi_3)

# jac

mod_wcvp_all_popsize_jac_1 = pgls(scale(jac) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_all_popsize_jac_1)

# bcd

mod_wcvp_all_popsize_bcd_1 = pgls(scale(bcd) ~ log10(wcvp_all_popsize) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcvp_all_popsize_bcd_1)


################################WCVP native range size vs diversity#################################

# pi
mod_wcvp_native_area_pi_1 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + log10(meancov) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcv_native_area_pi_1)

mod_wcvp_native_area_pi_2 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system + cultivation.status, compdata)
summary(mod_wcv_native_area_pi_2)

mod_wcvp_native_area_pi_3 = pgls(scale(log10(pi)) ~ log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system, compdata)
summary(mod_wcvp_native_area_pi_3)
plot(mod_wcvp_native_area_pi_3)

mod_mat_wcvp_native_area_pi = model.matrix(~log10(wcvp_native_area) + nidv + log10(genome.size) + cvbp + Mating.system, data = compdata$data) # minimal model, extract matrix
...
wcvp_native_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_pi$y, mod_wcvp_native_popsize_pi$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "log(Nucleotide diversity), adj.")

wcvp_all_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_pi$y, mod_wcvp_all_popsize_pi$Vt, "log10(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "log(Nucleotide diversity), adj.")

wcvp_all_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_pi$y, mod_wcvp_all_area_pi$Vt, "log10(wcvp_all_area)", "log(WCVP native+invaded range size, km^2), adj.", "log(Nucleotide diversity), adj.")

wcvp_native_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_pi$y, mod_wcvp_native_area_pi$Vt, "log10(wcvp_native_area)", "log(WCVP native range size, km^2), adj.", "log(Nucleotide diversity), adj.")

wcvp_native_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_jac$y, mod_wcvp_native_popsize_jac$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "Jaccard dissimilarity, adj.")

wcvp_all_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_jac$y, mod_wcvp_all_popsize_jac$Vt, "log10(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "Jaccard dissimilarity, adj.")

wcvp_all_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_jac$y, mod_wcvp_all_area_jac$Vt, "log10(wcvp_all_area)", "log(WCVP native+invaded range size, km^2), adj.", "Jaccard dissimilarity, adj.")

wcvp_native_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_jac$y, mod_wcvp_native_area_jac$Vt, "log10(wcvp_native_area)", "log(WCVP native range size, km^2), adj.", "Jaccard dissimilarity, adj.")

wcvp_native_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_bcd$y, mod_wcvp_native_popsize_bcd$Vt, "log10(wcvp_native_popsize)", "log(WCVP native proxy), adj.", "Bray-Curtis dissimilarity, adj.")

wcvp_all_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_bcd$y, mod_wcvp_all_popsize_bcd$Vt, "log10(wcvp_all_popsize)", "log(WCVP native+invaded proxy), adj.", "Bray-Curtis dissimilarity, adj.")

wcvp_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_bcd$y, mod_wcvp_all_area_bcd$Vt, "log10(wcvp_all_area)", "log(WCVP native+invaded range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")

wcvp_native_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_bcd$y, mod_wcvp_native_area_bcd$Vt, "log10(wcvp_native_area)", "log(WCVP native range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")

## gbif

# pi

gbif_native_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_pi$y, mod_gbif_native_popsize_pi$Vt, "log10(gbif_native_popsize)", "log(GBIF native proxy), adj.", "log(Nucleotide diversity), adj.")

gbif_all_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_pi$y, mod_gbif_all_popsize_pi$Vt, "log10(gbif_all_popsize)", "log(GBIF native+invaded proxy), adj.", "log(Nucleotide diversity), adj.")

gbif_all_area_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_pi$y, mod_gbif_all_area_pi$Vt, "log10(gbif_all_area)", "log(GBIF native+invaded range size, km^2), adj.", "log(Nucleotide diversity), adj.")
  
gbif_native_area_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_pi$y, mod_gbif_native_area_pi$Vt, "log10(gbif_native_area)", "log(GBIF native range size, km^2), adj.", "log(Nucleotide diversity), adj.")

# JAC

gbif_native_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_jac$y, mod_gbif_native_popsize_jac$Vt, "log10(gbif_native_popsize)", "log(GBIF native proxy), adj.", "Jaccard dissimilarity, adj.")

gbif_all_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_jac$y, mod_gbif_all_popsize_jac$Vt, "log10(gbif_all_popsize)", "log(GBIF native+invaded proxy), adj.", "Jaccard dissimilarity, adj.")

gbif_all_area_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_jac$y, mod_gbif_all_area_jac$Vt, "log10(gbif_all_area)", "log(GBIF native+invaded range size, km^2), adj.", "Jaccard dissimilarity, adj.")
  
gbif_native_area_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_jac$y, mod_gbif_native_area_jac$Vt, "log10(gbif_native_area)", "log(GBIF native range size, km^2), adj.", "Jaccard dissimilarity, adj.")

# bcd

gbif_native_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_bcd$y, mod_gbif_native_popsize_bcd$Vt, "log10(gbif_native_popsize)", "log(GBIF native proxy), adj.", "Bray-Curtis dissimilarity, adj.")

gbif_all_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_bcd$y, mod_gbif_all_popsize_bcd$Vt, "log10(gbif_all_popsize)", "log(GBIF native+invaded proxy), adj.", "Bray-Curtis dissimilarity, adj.")

gbif_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_bcd$y, mod_gbif_all_area_bcd$Vt, "log10(gbif_all_area)", "log(GBIF native+invaded range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")
  
gbif_native_area_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_bcd$y, mod_gbif_native_area_bcd$Vt, "log10(gbif_native_area)", "log(GBIF native range size, km^2), adj.", "Bray-Curtis dissimilarity, adj.")
...
#wcvp_pop_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_pi, mod_pi_1$y, mod_pi_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size proxy), scaled", "log10(Nucleotide diversity), scaled and adjusted")

#wcvp_pop_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_jac, mod_jac_1$y, mod_jac_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size proxy), scaled", "Jaccard dissimilarity, scaled and adjusted")

#wcvp_pop_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_bcd, mod_bcd_1$y, mod_bcd_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size proxy), scaled", "Bray-Curtis dissimilarity, scaled and adjusted")
...
## Do k-mers uncover more between species variation?
```{r eval=FALSE, include=FALSE}
...
ggarrange(ida_wcvp_vs_gbif_all, ida_wcvp_vs_gbif_native, nrow = 2, ncol = 1, labels = c("A", "B"), font.label = list(size = 20), hjust = -2)

ggsave(paste("wcvp_vs_gbif_", today, ".pdf", sep = ""), width = 5.2, height = 7.75, device = cairo_pdf)

# Jaccard vs bray-curtis dissimilarity
ggsave(paste("ida_jac_vs_bcd_", today, ".pdf", sep = ""), ida_jac_vs_bcd, width = 7, height = 7, device = cairo_pdf)

# Look at sequencing metrics influence diversity
ggarrange(ida_meancov_vs_pi, ida_cvbp_vs_pi, ida_nidv_vs_pi, ida_meancov_vs_jac, ida_cvbp_vs_jac, ida_nidv_vs_jac, ida_meancov_vs_bcd, ida_cvbp_vs_bcd, ida_nidv_vs_bcd, ncol = 3, nrow = 3, labels = c("A", "B", "C", "D", "E", "F", "G", "H", "I"), font.label = list(size = 20))

ggsave(paste("coverage_vs_diversity_", today, ".pdf", sep = ""), width = 20, height = 16, units = "in", device = cairo_pdf)
...
ggarrange(ida_pi_vs_jac, cda_pi_vs_jac, ida_pi_vs_bcd, cda_pi_vs_bcd, ncol = 2, nrow = 2, common.legend = T, labels = c("A", "B", "C", "D"), legend = "top", font.label = list(size = 20))

ggsave(paste("pi_vs_jac_and_bcd_high_vs_low_cov_", today, ".pdf", sep = ""), width = 11, height = 10, units = "in")

# Look at how cv in sequencing affect SNP vs k-mer comparison
ggarrange(ida_pi_vs_jac_cvbp, ida_pi_vs_bcd_cvbp, ncol = 2, nrow = 1, common.legend = T, labels = c("A", "B"), legend = "top", font.label = list(size = 20))
...
ggarrange(ida_pi_vs_jac_nidv, ida_pi_vs_bcd_nidv, ncol = 2, nrow = 1, common.legend = T, labels = c("A", "B"), legend = "top", font.label = list(size = 20))
...
ggarrange(ida_cultivation_vs_generation, ida_cultivation_vs_mating, ida_generation_vs_mating, labels = c("A", "B", "C"), font.label = list(size = 20), ncol = 3, nrow = 1, legend = "right")
...
ggarrange(cda_pi_vs_gbif, cda_pi_vs_wcvp, cda_jac_vs_gbif, cda_jac_vs_wcvp, cda_bcd_vs_gbif, cda_bcd_vs_wcvp, nrow = 3, ncol = 2, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("diversity_vs_popsize_", today, ".pdf", sep = ""), width = 12, height = 16, units = "in", device = cairo_pdf)

#### plot phylogenetic least squares models ####

## excluding genome size

ggarrange(wcvp_native_vs_pi_corrected, wcvp_native_vs_jac_corrected, wcvp_native_vs_bcd_corrected,wcvp_all_vs_pi_corrected, wcvp_all_vs_jac_corrected, wcvp_all_vs_bcd_corrected, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("wcvp_popsize_vs_diversity_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(wcvp_native_area_vs_pi_corrected, wcvp_native_area_vs_jac_corrected, wcvp_native_area_vs_bcd_corrected,wcvp_all_area_vs_pi_corrected, wcvp_all_area_vs_jac_corrected, wcvp_all_area_vs_bcd_corrected, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("wcvp_area_vs_diversity_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(gbif_native_vs_pi_corrected, gbif_native_vs_jac_corrected, gbif_native_vs_bcd_corrected,gbif_all_vs_pi_corrected, gbif_all_vs_jac_corrected, gbif_all_vs_bcd_corrected, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("gbif_popsize_vs_diversity_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(gbif_native_area_vs_pi_corrected, gbif_native_area_vs_jac_corrected, gbif_native_area_vs_bcd_corrected,gbif_all_area_vs_pi_corrected, gbif_all_area_vs_jac_corrected, gbif_all_area_vs_bcd_corrected, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("gbif_area_vs_diversity_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(height_vs_pi_corrected, height_vs_jac_corrected, height_vs_bcd_corrected, nrow = 1, ncol = 3, labels = c("A", "B", "C"), font.label = list(size = 20))

ggsave(paste("height_vs_diversity_corrected_", today, ".pdf", sep = ""), height = 6, width = 16, units = "in")

## including genome size

ggarrange(genome_wcvp_native_vs_pi_figure, genome_wcvp_native_vs_jac_figure, genome_wcvp_native_vs_bcd_figure,genome_wcvp_all_vs_pi_figure, genome_wcvp_all_vs_jac_figure, genome_wcvp_all_vs_bcd_figure, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("wcvp_popsize_vs_genome_size_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(genome_gbif_native_vs_pi_figure, genome_gbif_native_vs_jac_figure, genome_gbif_native_vs_bcd_figure,genome_gbif_all_vs_pi_figure, genome_gbif_all_vs_jac_figure, genome_gbif_all_vs_bcd_figure, nrow = 2, ncol = 3, labels = c("A", "B", "C", "D", "E", "F"), font.label = list(size = 20))

ggsave(paste("gbif_popsize_vs_genome_size_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")

ggarrange(genome_height_vs_pi_figure, genome_height_vs_jac_figure, genome_height_vs_bcd_figure, nrow = 1, ncol = 3, labels = c("A", "B", "C"), font.label = list(size = 20))

ggsave(paste("height_vs_genome_size_corrected_", today, ".pdf", sep = ""), height = 12, width = 16, units = "in")
...
all_mod_results = all_mod_results[,c(6,5,1:4)]

colnames(all_mod_results)[2] = "Variable"
...
ggtree(plotphy, size = 1.5) + 
  geom_tiplab(size = 6) +
  #geom_facet(panel = "log10(GBIF native proxy)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(gbif_native_popsize)), color = plotpal[1]) +
  geom_facet(panel = "log10(WCVP native proxy)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(wcvp_native_popsize)), color = plotpal[2]) +
  geom_facet(panel = "log10(Nucleotide diversity)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(pi)), color = plotpal[3]) +
  ...
  theme(strip.text = element_text(colour = 'black'), text = element_text(size = 30)) +
  xlim_tree(800)
  
ggsave(paste("tree_with_primary_variables_", today, ".png", sep = ""), width = 14, height = 28)
