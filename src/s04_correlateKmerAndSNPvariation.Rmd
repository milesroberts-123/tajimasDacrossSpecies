...
# Corylus americana is only native to north america
native_areas$`Corylus americana` = native_areas$`Corylus americana`[1,]
...
metadata$species = gsub("\xa0", " ", metadata$species, useBytes = T)
...
```{r}
#alldiv2 = read.table("../results/2023-03-26/final_covariates_2024-04-03.txt", sep = "\t", header = T)
alldiv = read.table("../results/2023-03-26/final_covariates_2024-09-08.txt", sep = "\t", header = T)
```
...
my_ggplot_wrap_xyz <- function(data, xcol, ycol, xname, yname, filename, zcol, lcol, hcol, lname, mylims, filew = 5, fileh = 5) {
  ...
  myplot = ggplot(data = data, aes_string(x = xcol, y = ycol)) + 
    geom_point(aes_string(fill = zcol), pch = 21, color = "black") +
    geom_smooth(method = "loess", color = "purple", n = 20) +
    theme_classic() +
    #stat_cor(method = "spearman", digits = 2, cor.coef.name = "rho", size = 7) +
    scale_fill_gradient(low = lcol, high = hcol, name = lname, limits = mylims) +
    labs(x = xname, y = yname, title = result_label) +
    theme(text = element_text(size = 12))
...
ida_meancov_vs_pi = my_ggplot_wrap(alldiv, "log10(meancov)", "log10(pi)", "log(mean coverage)", "log(4-fold SNP diversity)", paste("ida_coverage-vs-pi_", today, ".png", sep = ""))
...
ida_cvbp_vs_pi = my_ggplot_wrap(alldiv, "cvbp", "log10(pi)", "coeff. of var. in bp sequenced", "log(4-fold SNP diversity)", paste("ida_cvbp-vs-pi_", today, ".png", sep = ""))

ida_cvbp_vs_jac = my_ggplot_wrap(alldiv, "cvbp", "jac", "coeff. of var. in bp sequenced", "Jaccard dissimilarity", paste("ida_cvbp-vs-jac_", today, ".png", sep = ""))

ida_cvbp_vs_bcd = my_ggplot_wrap(alldiv, "cvbp", "bcd", "coeff. of var. in bp sequenced", "Bray-Curtis dissimilarity", paste("ida_cvbp-vs-bcd_", today, ".png", sep = ""))

## number of individuals sequenced vs diversity
ida_nidv_vs_pi = my_ggplot_wrap(alldiv, "log10(nidv)", "log10(pi)", "log(Number of individuals)", "log(4-fold SNP diversity)", paste("ida_nidv-vs-pi_", today, ".png", sep = ""))
...
ida_nvariant_vs_pi = my_ggplot_wrap(alldiv, "log10(nvariant + 1)", "log10(pi)", "log(Number of variant sites + 1)", "log(4-fold SNP diversity)", paste("ida_nvariant-vs-pi_", today, ".png", sep = ""))
...
ida_pi_vs_jac = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "jac", 'log(4-fold SNP diversity)', "Jaccard dissimilarity", paste("ida_pi-vs-jac_", today, ".png", sep = ""), "log10(meancov)", "#FEF2F2", "#190C64", 'log(mean coverage)', c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))

ida_pi_vs_bcd = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "bcd", "log(4-fold SNP diversity)", "Bray-Curtis dissimilarity", paste("ida_pi-vs-bcd_", today, ".png", sep = ""), "log10(meancov)", "#FEF2F2", "#190C64", "log(mean coverage)", c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))

# compare diversity measures, colored by variation in coverage
ida_pi_vs_jac_cvbp = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "jac", "log10(4-fold SNP diversity)", "Jaccard dissimilarity", paste("ida_pi-vs-jac_cvbp_", today, ".png", sep = ""), "cvbp", "#FEF2F2", "#190C64", "Coeff.\nof variation\nbp sequenced", c(min(alldiv$cvbp), max(alldiv$cvbp)))

ida_pi_vs_bcd_cvbp = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "bcd", "log10(4-fold SNP diversity)", "Bray-Curtis dissimilarity", paste("ida_pi-vs-bcd_cvbp_", today, ".png", sep = ""), "cvbp", "#FEF2F2", "#190C64", "Coeff.\nof variation\nbp sequenced", c(min(alldiv$cvbp), max(alldiv$cvbp)))

# compare diversity measures, colored by number of individuals sequenced
ida_pi_vs_jac_nidv = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "jac", "log(4-fold SNP diversity)", "Jaccard dissimilarity", paste("ida_pi-vs-jac_nidv_", today, ".png", sep = ""), "log10(nidv)", "#FEF2F2", "#190C64", "log(Number of\nindividuals\nsequenced)", c(min(log10(alldiv$nidv)), max(log10(alldiv$nidv))))

ida_pi_vs_bcd_nidv = my_ggplot_wrap_xyz(alldiv, "log10(pi)", "bcd", "log(4-fold SNP diversity)", "Bray-Curtis dissimilarity", paste("ida_pi-vs-bcd_nidv_", today, ".png", sep = ""), "log10(nidv)", "#FEF2F2", "#190C64", "log(Number of\nindividuals\nsequenced)", c(min(log10(alldiv$nidv)), max(log10(alldiv$nidv))))
...
ida_mating_vs_pi = my_ggplot_wrap_box(alldiv, "Mating.system", "log10(pi)", "Mating system", "log10(4-fold SNP diversity)", paste("mating_vs_pi_", today, ".png", sep = ""))
...
ida_ploidy_vs_pi = my_ggplot_wrap_box(alldiv, "Ploidy", "log10(pi)", "Ploidy", "log10(4-fold SNP diversity)", paste("ploidy_vs_pi_", today, ".png", sep = ""))
...
ida_cult_vs_pi = my_ggplot_wrap_box(alldiv, "cultivation.status", "log10(pi)", "Cultivation status", "log10(4-fold SNP diversity)", paste("cultivation_vs_pi_", today, ".png", sep = ""))
...
## replot trends
```{r}
my_ggplot_wrap(subdiv, "log10(meancov)", "log10(pi)", "log10(mean coverage)", "log10(4-fold SNP diversity)", paste("cda_coverage-vs-pi_", today, ".png", sep = ""))
...
my_ggplot_wrap(subdiv, "cvbp", "log10(pi)", "coeff. of var. in bp sequenced", "log10(4-fold SNP diversity)", paste("cda_cvbp-vs-pi_", today, ".png", sep = ""))

my_ggplot_wrap(subdiv, "cvbp", "jac", "coeff. of var. in bp sequenced", "Jaccard dissimilarity", paste("cda_cvbp-vs-jac_", today, ".png", sep = ""))

my_ggplot_wrap(subdiv, "cvbp", "bcd", "coeff. of var. in bp sequenced", "Bray-Curtis dissimilarity", paste("cda_cvbp-vs-bcd_", today, ".png", sep = ""))

cda_pi_vs_jac = my_ggplot_wrap_xyz(subdiv, "log10(pi)", "jac", "log(4-fold SNP diversity)", "Jaccard dissimilarity", paste("cda_pi-vs-jac_", today, ".png", sep = ""), "log10(meancov)", "#FEF2F2", "#190C64", "log(mean coverage)", c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))

cda_pi_vs_bcd = my_ggplot_wrap_xyz(subdiv, "log10(pi)", "bcd", "log(4-fold SNP diversity)", "Bray-Curtis dissimilarity", paste("cda_pi-vs-bcd_", today, ".png", sep = ""), "log10(meancov)", "#FEF2F2", "#190C64", "log(mean coverage)", c(min(log10(alldiv$meancov)), max(log10(alldiv$meancov))))
...
cda_pi_vs_wcvp = my_ggplot_wrap(subdiv, "log10(pi)", "log10(wcvp_native_popsize)", "log(4-fold SNP diversity)", "log(WCVP native ratio)", paste("cda_pi-vs-wcvp_", today, ".png", sep = ""))

cda_pi_vs_gbif = my_ggplot_wrap(subdiv, "log10(pi)", "log10(gbif_native_popsize)", "log(4-fold SNP diversity)", "log(GBIF native ratio)", paste("cda_pi-vs-gbif_", today, ".png", sep = ""))
...
correct_and_plot = function(mod_mat, y, V, primary, xlab, ylab, xpos, ypos){
  ...
  myplot = ggplot(mapping = aes(x = X_star[,primary], y = y_star_corrected)) +
    ...
    geom_abline(intercept = 0, 
                slope = coeff_star[primary] - slope_se_value, 
                color = "black", 
                linetype = "dotted") +
    geom_abline(intercept = 0, 
                slope = coeff_star[primary], 
                color = "purple") +
    geom_abline(intercept = 0, 
                slope = coeff_star[primary] + slope_se_value, 
                color = "black", 
...
wcvp_native_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_pi$y, mod_wcvp_native_popsize_pi$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

wcvp_all_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_pi$y, mod_wcvp_all_popsize_pi$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

wcvp_all_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_pi$y, mod_wcvp_all_area_pi$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

wcvp_native_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_pi$y, mod_wcvp_native_area_pi$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

wcvp_native_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_jac$y, mod_wcvp_native_popsize_jac$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

wcvp_all_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_jac$y, mod_wcvp_all_popsize_jac$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

wcvp_all_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_jac$y, mod_wcvp_all_area_jac$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

wcvp_native_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_jac$y, mod_wcvp_native_area_jac$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

wcvp_native_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_native, mod_wcvp_native_popsize_bcd$y, mod_wcvp_native_popsize_bcd$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

wcvp_all_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all, mod_wcvp_all_popsize_bcd$y, mod_wcvp_all_popsize_bcd$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

wcvp_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_all_area, mod_wcvp_all_area_bcd$y, mod_wcvp_all_area_bcd$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

wcvp_native_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_native_area, mod_wcvp_native_area_bcd$y, mod_wcvp_native_area_bcd$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif

# pi

gbif_native_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_pi$y, mod_gbif_native_popsize_pi$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

gbif_all_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_pi$y, mod_gbif_all_popsize_pi$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

gbif_all_area_vs_pi_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_pi$y, mod_gbif_all_area_pi$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")
  
gbif_native_area_vs_pi_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_pi$y, mod_gbif_native_area_pi$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

# JAC

gbif_native_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_jac$y, mod_gbif_native_popsize_jac$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

gbif_all_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_jac$y, mod_gbif_all_popsize_jac$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

gbif_all_area_vs_jac_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_jac$y, mod_gbif_all_area_jac$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")
  
gbif_native_area_vs_jac_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_jac$y, mod_gbif_native_area_jac$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

# bcd

gbif_native_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native, mod_gbif_native_popsize_bcd$y, mod_gbif_native_popsize_bcd$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

gbif_all_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all, mod_gbif_all_popsize_bcd$y, mod_gbif_all_popsize_bcd$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

gbif_all_area_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_all_area, mod_gbif_all_area_bcd$y, mod_gbif_all_area_bcd$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")
  
gbif_native_area_vs_bcd_corrected = correct_and_plot(mod_mat_gbif_native_area, mod_gbif_native_area_bcd$y, mod_gbif_native_area_bcd$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## height

height_vs_pi_corrected = correct_and_plot(mod_mat_height, mod_height_pi$y, mod_height_pi$Vt, "log10(height_final)", "log(height, m)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

height_vs_jac_corrected = correct_and_plot(mod_mat_height, mod_height_jac$y, mod_height_jac$Vt, "log10(height_final)", "log(height, m)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

height_vs_bcd_corrected = correct_and_plot(mod_mat_height, mod_height_bcd$y, mod_height_bcd$Vt, "log10(height_final)", "log(height, m)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")


#wcvp_pop_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_pi, mod_pi_1$y, mod_pi_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size ratio)\nscaled", "log10(4-fold SNP diversity)\nscaled and adjusted")

#wcvp_pop_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_jac, mod_jac_1$y, mod_jac_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

#wcvp_pop_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_pop_vs_bcd, mod_bcd_1$y, mod_bcd_1$Vt, "log10(wcvp_native_popsize)", "log10(WCVP pop size ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

#wcvp_area_vs_pi_corrected = correct_and_plot(mod_mat_wcvp_area_vs_pi, mod_pi_wcvp_area_3$y, mod_pi_wcvp_area_3$Vt, "log10(area)", "log10(WCVP range in square km)\nscaled", "log10(4-fold SNP diversity)\nscaled and adjusted")

#wcvp_area_vs_jac_corrected = correct_and_plot(mod_mat_wcvp_area_vs_jac, mod_jac_wcvp_area_1$y, mod_jac_wcvp_area_1$Vt, "log10(area)", "log10(WCVP range in square km)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

#wcvp_area_vs_bcd_corrected = correct_and_plot(mod_mat_wcvp_area_vs_bcd, mod_bcd_wcvp_area_2$y, mod_bcd_wcvp_area_2$Vt, "log10(area)", "log10(WCVP range in square km)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")
...
## gbif all ratio
genome_gbif_all_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_pi$y, genome_gbif_all_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_gbif_all_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_jac$y, genome_gbif_all_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_gbif_all_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_bcd$y, genome_gbif_all_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif native ratio
genome_gbif_native_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_pi$y, genome_gbif_native_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_gbif_native_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_jac$y, genome_gbif_native_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_gbif_native_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_bcd$y, genome_gbif_native_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif all range size
genome_gbif_all_area_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_pi$y, genome_gbif_all_area_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_gbif_all_area_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_jac$y, genome_gbif_all_area_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_gbif_all_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_bcd$y, genome_gbif_all_area_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif native range size
genome_gbif_native_area_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_pi$y, genome_gbif_native_area_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_gbif_native_area_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_jac$y, genome_gbif_native_area_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_gbif_native_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_bcd$y, genome_gbif_native_area_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp all
genome_wcvp_all_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_pi$y, genome_wcvp_all_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_wcvp_all_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_jac$y, genome_wcvp_all_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_wcvp_all_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_bcd$y, genome_wcvp_all_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp native
genome_wcvp_native_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_pi$y, genome_wcvp_native_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_wcvp_native_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_jac$y, genome_wcvp_native_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_wcvp_native_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_bcd$y, genome_wcvp_native_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp all range size
genome_wcvp_all_area_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_pi$y, genome_wcvp_all_area_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_wcvp_all_area_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_jac$y, genome_wcvp_all_area_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_wcvp_all_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_bcd$y, genome_wcvp_all_area_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp native range size
genome_wcvp_native_area_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_pi$y, genome_wcvp_native_area_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_wcvp_native_area_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_jac$y, genome_wcvp_native_area_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_wcvp_native_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_bcd$y, genome_wcvp_native_area_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## height
genome_height_vs_pi_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_pi$y, genome_height_vs_pi$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

genome_height_vs_jac_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_jac$y, genome_height_vs_jac$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

genome_height_vs_bcd_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_bcd$y, genome_height_vs_bcd$Vt, "log10(genome.size)", "log(genome size in bp)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")
```

### Population size vs diversity, controlling for genome size
```{r}
## gbif all ratio
pop_genome_gbif_all_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_pi$y, genome_gbif_all_vs_pi$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_gbif_all_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_jac$y, genome_gbif_all_vs_jac$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_gbif_all_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_all, genome_gbif_all_vs_bcd$y, genome_gbif_all_vs_bcd$Vt, "log10(gbif_all_popsize)", "log(GBIF full ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif native ratio
pop_genome_gbif_native_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_pi$y, genome_gbif_native_vs_pi$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_gbif_native_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_jac$y, genome_gbif_native_vs_jac$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_gbif_native_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_native, genome_gbif_native_vs_bcd$y, genome_gbif_native_vs_bcd$Vt, "log10(gbif_native_popsize)", "log(GBIF native ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif all range size
pop_genome_gbif_all_area_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_pi$y, genome_gbif_all_area_vs_pi$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_gbif_all_area_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_jac$y, genome_gbif_all_area_vs_jac$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_gbif_all_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_all_area, genome_gbif_all_area_vs_bcd$y, genome_gbif_all_area_vs_bcd$Vt, "log10(gbif_all_area)", "log(GBIF full range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## gbif native range size
pop_genome_gbif_native_area_vs_pi_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_pi$y, genome_gbif_native_area_vs_pi$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_gbif_native_area_vs_jac_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_jac$y, genome_gbif_native_area_vs_jac$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_gbif_native_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_gbif_native_area, genome_gbif_native_area_vs_bcd$y, genome_gbif_native_area_vs_bcd$Vt, "log10(gbif_native_area)", "log(GBIF native range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp all
pop_genome_wcvp_all_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_pi$y, genome_wcvp_all_vs_pi$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_wcvp_all_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_jac$y, genome_wcvp_all_vs_jac$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_wcvp_all_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_all, genome_wcvp_all_vs_bcd$y, genome_wcvp_all_vs_bcd$Vt, "log10(wcvp_all_popsize)", "log(WCVP full ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp native
pop_genome_wcvp_native_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_pi$y, genome_wcvp_native_vs_pi$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_wcvp_native_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_jac$y, genome_wcvp_native_vs_jac$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_wcvp_native_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_native, genome_wcvp_native_vs_bcd$y, genome_wcvp_native_vs_bcd$Vt, "log10(wcvp_native_popsize)", "log(WCVP native ratio)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp all range size
pop_genome_wcvp_all_area_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_pi$y, genome_wcvp_all_area_vs_pi$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_wcvp_all_area_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_jac$y, genome_wcvp_all_area_vs_jac$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_wcvp_all_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_all_area, genome_wcvp_all_area_vs_bcd$y, genome_wcvp_all_area_vs_bcd$Vt, "log10(wcvp_all_area)", "log(WCVP full range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## wcvp native range size
pop_genome_wcvp_native_area_vs_pi_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_pi$y, genome_wcvp_native_area_vs_pi$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_wcvp_native_area_vs_jac_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_jac$y, genome_wcvp_native_area_vs_jac$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_wcvp_native_area_vs_bcd_figure = correct_and_plot(genome_mod_mat_wcvp_native_area, genome_wcvp_native_area_vs_bcd$y, genome_wcvp_native_area_vs_bcd$Vt, "log10(wcvp_native_area)", "log(WCVP native range, km^2)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")

## height
pop_genome_height_vs_pi_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_pi$y, genome_height_vs_pi$Vt, "log10(height_final)", "log(height in m)\nscaled", "log(4-fold SNP diversity)\nscaled and adjusted")

pop_genome_height_vs_jac_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_jac$y, genome_height_vs_jac$Vt, "log10(height_final)", "log(height in m)\nscaled", "Jaccard dissimilarity\nscaled and adjusted")

pop_genome_height_vs_bcd_figure = correct_and_plot(genome_mod_mat_height, genome_height_vs_bcd$y, genome_height_vs_bcd$Vt, "log10(height_final)", "log(height in m)\nscaled", "Bray-Curtis dissimilarity\nscaled and adjusted")
```
...
ggsave(paste("wcvp_vs_gbif_", today, ".jpg", sep = ""), width = 6, height = 6, dpi = 350)

# Jaccard vs bray-curtis dissimilarity
ggsave(paste("ida_jac_vs_bcd_", today, ".jpg", sep = ""), ida_jac_vs_bcd, width = 4, height = 4, dpi = 350)
...
ggsave(paste("coverage_vs_diversity_", today, ".jpg", sep = ""), width = 10, height = 8, units = "in", dpi = 350)
...
#ggsave(paste("mating_cultivation_ploidy_vs_diversity_", today, ".jpg", sep = ""), width = 10, height = 10, units = "in", dpi = 350)
...
ggsave(paste("pi_vs_bcd_high_vs_low_cov_", today, ".jpg", sep = ""), width = 6, height = 4, units = "in", dpi = 350)

ggarrange(ida_pi_vs_jac, cda_pi_vs_jac, ncol = 2, nrow = 1, common.legend = T, labels = c("A", "B"), legend = "top", font.label = list(size = 12))

ggsave(paste("pi_vs_jac_high_vs_low_cov_", today, ".jpg", sep = ""), width = 6, height = 4, units = "in", dpi = 350)
...
ggsave(paste("pi_vs_jac_and_bcd_cvbp_", today, ".jpg", sep = ""), width = 9, height = 6, units = "in", dpi = 350)
...
ggsave(paste("pi_vs_jac_and_bcd_nidv_", today, ".jpg", sep = ""), width = 9, height = 6, units = "in", dpi = 350)
...
ggsave(paste("cultivation_vs_generation_and_mating", today, ".jpg", sep = ""), width = 15, height = 4, units = "in", dpi = 350)
...
ggsave(paste("diversity_vs_popsize_", today, ".jpg", sep = ""), width = 6, height = 8, units = "in", dpi = 350)
...
ggsave(paste("wcvp_popsize_vs_diversity_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("wcvp_area_vs_diversity_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_popsize_vs_diversity_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_area_vs_diversity_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("height_vs_diversity_corrected_", today, ".jpg", sep = ""), height = 3, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("wcvp_all_popsize_vs_pi_and_bcd_genome-size-corrected_", today, ".jpg", sep = ""), height = 3, width = 5, units = "in", dpi = 350)

ggarrange(pop_genome_wcvp_all_vs_jac_figure)

ggsave(paste("wcvp_all_popsize_vs_jac_genome-size-corrected_", today, ".jpg", sep = ""), height = 3, width = 3, units = "in", dpi = 350)
...
ggsave(paste("wcvp_native_popsize_vs_diversity_genome-size-corrected_", today, ".jpg", sep = ""), height = 3, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_popsize_vs_diversity_genome-size-corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("wcvp_area_vs_diversity_genome-size-corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_area_vs_diversity_genome-size-corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("height_vs_diversity_genome-size-corrected_", today, ".jpg", sep = ""), height = 4, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("pi_bcd_vs_genome_size_wcvp-all-corrected_", today, ".jpg", sep = ""), height = 3, width = 5, units = "in", dpi = 350)

ggarrange(genome_wcvp_all_vs_jac_figure)

ggsave(paste("jac_vs_genome_size_wcvp-all-corrected_", today, ".jpg", sep = ""), height = 3, width = 3, units = "in", dpi = 350)
...
ggsave(paste("pi_jac_bcd_vs_genome_size_wcvp-native-corrected_", today, ".jpg", sep = ""), height = 3, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_popsize_vs_genome_size_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("wcvp_area_vs_genome_size_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("gbif_area_vs_genome_size_corrected_", today, ".jpg", sep = ""), height = 6, width = 7.5, units = "in", dpi = 350)
...
ggsave(paste("height_vs_genome_size_corrected_", today, ".jpg", sep = ""), height = 4, width = 7.5, units = "in", dpi = 350)

#### save results of phylogenetic least squares models as tables ####

mod_coeff_results = rbind(
...
mod_coeff_results = cbind(mod_coeff_results, rownames(mod_coeff_results))

# convert to dataframe
mod_coeff_results = as.data.frame(mod_coeff_results)
...
#mod_coeff_results$Response = rep(
#    c(
#      rep("4-fold SNP diversity", times = 5),
...
#mod_coeff_results$`Population size metric` = c(
#  rep("GBIF", times = 30),
#  rep("WCVP", times = 30)
#)

#mod_coeff_results$`Range included` = c(
#  rep("full", times = 15),
...
mod_coeff_results = mod_coeff_results[,c(7,6,5,1:4)]

colnames(mod_coeff_results)[3] = "Variable"

# save results
write.csv(mod_coeff_results, paste("model_coefficients_", today, ".csv", sep = ""), row.names = F)

#### Save whole model statistics as a separate table ####

# Write function to extract statistics that apply to entire model
extract_mod_results = function(mod){
  mod_sum = summary(mod)
  mod_frame = data.frame(
    call = as.character(mod_sum$call)[2],
    fstatvalue = mod_sum$fstatistic["value"],
    fstatnumdf = mod_sum$fstatistic["numdf"],
    fstatdendf = mod_sum$fstatistic["dendf"],
    rsq = mod_sum$r.squared,
    adjrsq = mod_sum$adj.r.squared[1,1]
  )
  return(mod_frame)
}

whole_mod_results = rbind(
  extract_mod_results(mod_gbif_all_popsize_pi),
  extract_mod_results(mod_gbif_all_popsize_jac),
  extract_mod_results(mod_gbif_all_popsize_bcd),
  extract_mod_results(mod_gbif_all_area_pi),
  extract_mod_results(mod_gbif_all_area_jac),
  extract_mod_results(mod_gbif_all_area_bcd),
  extract_mod_results(mod_gbif_native_popsize_pi),
  extract_mod_results(mod_gbif_native_popsize_jac),
  extract_mod_results(mod_gbif_native_popsize_bcd),
  extract_mod_results(mod_gbif_native_area_pi),
  extract_mod_results(mod_gbif_native_area_jac),
  extract_mod_results(mod_gbif_native_area_bcd),
  extract_mod_results(mod_wcvp_all_popsize_pi),
  extract_mod_results(mod_wcvp_all_popsize_jac),
  extract_mod_results(mod_wcvp_all_popsize_bcd),
  extract_mod_results(mod_wcvp_all_area_pi),
  extract_mod_results(mod_wcvp_all_area_jac),
  extract_mod_results(mod_wcvp_all_area_bcd),
  extract_mod_results(mod_wcvp_native_popsize_pi),
  extract_mod_results(mod_wcvp_native_popsize_jac),
  extract_mod_results(mod_wcvp_native_popsize_bcd),
  extract_mod_results(mod_wcvp_native_area_pi),
  extract_mod_results(mod_wcvp_native_area_jac),
  extract_mod_results(mod_wcvp_native_area_bcd),
  extract_mod_results(mod_height_pi),
  extract_mod_results(mod_height_jac),
  extract_mod_results(mod_height_bcd),
  extract_mod_results(genome_wcvp_all_vs_pi),
  extract_mod_results(genome_wcvp_all_vs_jac),
  extract_mod_results(genome_wcvp_all_vs_bcd),
  extract_mod_results(genome_wcvp_native_vs_pi),
  extract_mod_results(genome_wcvp_native_vs_jac),
  extract_mod_results(genome_wcvp_native_vs_bcd),
  extract_mod_results(genome_wcvp_all_area_vs_pi),
  extract_mod_results(genome_wcvp_all_area_vs_jac),
  extract_mod_results(genome_wcvp_all_area_vs_bcd),
  extract_mod_results(genome_wcvp_native_area_vs_pi),
  extract_mod_results(genome_wcvp_native_area_vs_jac),
  extract_mod_results(genome_wcvp_native_area_vs_bcd),
  extract_mod_results(genome_gbif_all_vs_pi),
  extract_mod_results(genome_gbif_all_vs_jac),
  extract_mod_results(genome_gbif_all_vs_bcd),
  extract_mod_results(genome_gbif_native_vs_pi),
  extract_mod_results(genome_gbif_native_vs_jac),
  extract_mod_results(genome_gbif_native_vs_bcd),
  extract_mod_results(genome_gbif_all_area_vs_pi),
  extract_mod_results(genome_gbif_all_area_vs_jac),
  extract_mod_results(genome_gbif_all_area_vs_bcd),
  extract_mod_results(genome_gbif_native_area_vs_pi),
  extract_mod_results(genome_gbif_native_area_vs_jac),
  extract_mod_results(genome_gbif_native_area_vs_bcd),
  extract_mod_results(genome_height_vs_pi),
  extract_mod_results(genome_height_vs_jac),
  extract_mod_results(genome_height_vs_bcd)
)

whole_mod_results$ID = 1:54

names(whole_mod_results) = c("Model", "F statistic", "F test df1", "F test df2", "R squared", "Adjusted R squared", "ID")

whole_mod_results = whole_mod_results[,c(7,1:6)]

write.csv(whole_mod_results, paste("model_rsquared_", today, ".csv", sep = ""), row.names = F, quote = F)
...
plotdf$retained = (plotdf$nvariant >= 1000 & plotdf$meancov > 0.5)
...
# vector of colors to show outlier vs not
# scico(2, palette = "bam")
outlier_colors = plotdf$retained
outlier_colors[outlier_colors] = "#0C4C00"
outlier_colors[(outlier_colors == FALSE)] = "#65014B"

# plot phylogeny alongside other data
ggtree(plotphy, size = 1.5) + 
  geom_tiplab(color = outlier_colors, size = 2, offset = 10) +
  #geom_tippoint(aes(shape = retained, node = NULL), data = plotdf, size = 1.5) +
  #geom_facet(panel = "Retained", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = x, color = retained)) +
  ...
  geom_facet(panel = "log(4-fold SNP diversity)", data = plotdf, geom = geom_segment, size = 3, mapping = aes(x = 0, y = y, yend = y, xend = log10(pi)), color = plotpal[3]) +
...
ggsave(paste("tree_with_primary_variables_", today, ".jpg", sep = ""), width = 7.5, height = 7.75, dpi = 350)
...
ggsave(paste("tree_with_technical_variables_", today, ".jpg", sep = ""), width = 7.5, height = 7.75, dpi = 350)
