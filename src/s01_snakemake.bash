...
snakemake --cluster "sbatch --time 2-00:00:00 --partition=josephsnodes --account=josephsnodes --cpus-per-task={threads} --mem-per-cpu={resources.mem_mb_per_cpu}" --jobs 999 --cores 999 --use-envmodules --rerun-incomplete -T 3
