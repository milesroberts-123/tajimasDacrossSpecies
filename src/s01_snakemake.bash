...
snakemake --cluster "sbatch --time 4-00:00:00 --partition=josephsnodes --account=josephsnodes --cpus-per-task={threads} --mem-per-cpu={resources.mem_mb_per_cpu}" --jobs 999 --cores 511 --use-envmodules --rerun-incomplete
