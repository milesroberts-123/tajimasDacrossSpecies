...
snakemake --cluster "sbatch --time 7-00:00:00 --partition=josephsnodes --account=josephsnodes --cpus-per-task={threads} --mem-per-cpu={resources.mem_mb_per_cpu}" --jobs 900 --cores 1024 --use-conda --rerun-incomplete --rerun-triggers mtime --retries 2 --resources load=3 --scheduler greedy --cluster-cancel "scancel"
